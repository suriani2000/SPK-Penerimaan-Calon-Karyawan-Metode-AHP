...
Adodc1.RecordSource = "view_hasil"
Adodc1.RecordSource = "select * from view_hasil"
Adodc1.Refresh
...
DataGrid1.Columns(2).Caption = "K1"
DataGrid1.Columns(3).Caption = "K2"
DataGrid1.Columns(4).Caption = "K3"
DataGrid1.Columns(5).Caption = "K4"
DataGrid1.Columns(6).Caption = "Nilai Akhir"
...
Adodc1.RecordSource = "select * from view_hasil where idpenilaian like '%" & TXTCARI & "%'"
Adodc1.Refresh
Atur_Grid
End Sub
